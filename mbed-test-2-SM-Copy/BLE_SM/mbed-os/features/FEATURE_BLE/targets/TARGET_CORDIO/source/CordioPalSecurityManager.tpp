...
ble_error_t CordioSecurityManager<EventHandler>::enable_encryption_(
	...
	printf(" CordioSecurityManager:enable_encryption_ 5 params :In \n\r");
    dmSecLtk_t sec_ltk;
...
ble_error_t CordioSecurityManager<EventHandler>::enable_encryption_(
	...
	printf("CordioSecurityManager:enable_encryption_ 3 params :In \n\r");
...
ble_error_t CordioSecurityManager<EventHandler>::set_ltk_(
	...
	printf("CordioSecurityManager::set_ltk_ %d", security_level);
    DmSecLtkRsp(
        connection,
        /* key found */ true,
...
bool CordioSecurityManager<EventHandler>::sm_handler(const wsfMsgHdr_t* msg) {
	...
	switch (msg->event) {
        ...
        case DM_SEC_ENCRYPT_IND: {
			...
			printf(" msg->event =  %d = DM_SEC_ENCRYPT_IND ",DM_SEC_ENCRYPT_IND);
        ...
        case DM_SEC_ENCRYPT_FAIL_IND: {
			...
			printf(" msg->event =  %d = DM_SEC_ENCRYPT_FAIL_IND ",DM_SEC_ENCRYPT_FAIL_IND);
...
#if BLE_FEATURE_PRIVACY
                case DM_KEY_IRK:
                    printf("\n\ r DM_KEY_IRK on_keys_distributed_irk\n\r");
        ...
        case DM_SEC_PAIR_IND: {
			...
			printf(" \n\ r DM_SEC_PAIR_IND  iKeyDist %d rKeyDist %d\n\r", evt->iKeyDist, evt->rKeyDist);
            return true;
        }

        case DM_SEC_SLAVE_REQ_IND: {
            printf(" \n\ r DM_SEC_SLAVE_REQ_IND\n\r");
            dmSecPairIndEvt_t* evt = (dmSecPairIndEvt_t*) msg;
